...
{
	return ext2fs_u32_list_add((ext2_u32_list) bb, (u32) blk);
}
 ...
 * list.
 */
int ext2fs_u32_list_find(ext2_u32_list bb, u32 blk)
{
	int	low, high, mid;
 ...
 * list.
 */
int ext2fs_u32_list_test(ext2_u32_list bb, u32 blk)
{
...
{
	return ext2fs_u32_list_test((ext2_u32_list) bb, (u32) blk);
}
 ...
 */
int ext2fs_u32_list_del(ext2_u32_list bb, u32 blk)
{
	int	remloc, i;
...
void ext2fs_badblocks_list_del(ext2_u32_list bb, u32 blk)
{
...
int ext2fs_u32_list_iterate(ext2_u32_iterate iter, u32 *blk)
{
	ext2_u32_list	bb;
