...
static inline unsigned long le32_to_cpu(unsigned long x)
{
...
static char md5_string[sizeof("d41d8cd98f00b204e9800998ecf8427e")];
static unsigned int length;
static char buffer[64];

static void md5_transform(const char block[64])
{
	int i, j;
	UINT4 a, b, c, d, tmp;
...
static unsigned char *md5_final(void)
{
...
char *md5sum_string(const char *input, int len)
{
	unsigned int i;
	unsigned char *md5;
	md5_init();
